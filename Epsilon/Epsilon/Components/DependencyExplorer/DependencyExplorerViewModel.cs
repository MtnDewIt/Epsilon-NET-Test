...
namespace Epsilon.Components.DependencyExplorer
{
    class DependencyExplorerViewModel : CacheEditorTool
    {
        public const string ToolName = "Epsilon.DependencyExplore";
        ...
        public DependencyExplorerViewModel(ICacheEditor editor)
        {
            ...
            TagTree.TagTreeViewModel tagTree = (editor.TagTree as TagTree.TagTreeViewModel);
