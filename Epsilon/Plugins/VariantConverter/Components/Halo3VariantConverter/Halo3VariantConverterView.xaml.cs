...
{
    /// <summary>
    /// Interaction logic for Halo3VariantConverterView.xaml
    /// </summary>
    [Export]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class Halo3VariantConverterView : UserControl
    {
        public Halo3VariantConverterView()
        {
            InitializeComponent();
        ...
        {
            if (e.OldValue is Halo3VariantConverterViewModel oldModel)
                oldModel.PropertyChanged -= Model_PropertyChanged;

            if (e.NewValue is Halo3VariantConverterViewModel newModel)
                newModel.PropertyChanged += Model_PropertyChanged;
        }

        private void Model_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            if (e.PropertyName == nameof(Halo3VariantConverterViewModel.Output))
            {
        ...
        private void ListBox_Drop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
                ...
                (this.DataContext as Halo3VariantConverterViewModel).AddFiles(files);
            }
